...
class VideoRenderer:
            ...
            try:
                ...
                with Progress(
                    ...
                    for frame_idx in range(total_frames):
                        ...
                        # Update DB progress every 30 frames and on the last frame
                        if self.db and self.job_id and (frame_idx % 30 == 0 or frame_idx == total_frames - 1):
    ...
    async def mux_audio(video_path: str, audio_path: str, final_path: str):
        ...
        logger.info("Đang trộn âm thanh vào video...")

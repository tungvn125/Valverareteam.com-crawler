...
async def test_list_my_voices(db):
    _v1 = await db.create_voice_sample(
        user_id="local",
        name="Voice 1",
        description="",
        ref_audio_path="local/v1.wav",
        ref_text="Giọng số một",
        duration_ms=3000,
        sample_rate=22050,
        gender="female",
    ...
    _v2 = await db.create_voice_sample(
        user_id="local",
        name="Voice 2",
        description="",
        ref_audio_path="local/v2.wav",
        ref_text="Giọng số hai",
        duration_ms=4000,
        sample_rate=22050,
        gender="male",
        age_group="adult",
...
async def test_list_community_voices(db):
    await db.create_voice_sample(
        ...
        name="Public Voice",
        description="",
        ref_audio_path="local/pv.wav",
        ref_text="Giọng công khai",
        duration_ms=5000,
        sample_rate=22050,
        gender="female",
        age_group="teen",
    ...
    await db.create_voice_sample(
        ...
        name="Private Voice",
        description="",
        ref_audio_path="local/pv2.wav",
        ref_text="Giọng riêng tư",
        duration_ms=6000,
        sample_rate=22050,
        gender="male",
        age_group="adult",
...
async def test_find_best_voice(db):
    v1 = await db.create_voice_sample(
        ...
        name="Male Adult",
        description="",
        ref_audio_path="u1/v1.wav",
        ref_text="Giọng nam trưởng thành",
        duration_ms=5000,
        sample_rate=22050,
        gender="male",
        age_group="adult",
    ...
    v2 = await db.create_voice_sample(
        ...
        name="Male Adult 2",
        description="",
        ref_audio_path="u2/v2.wav",
        ref_text="Giọng nam khác",
        duration_ms=4000,
        sample_rate=22050,
        gender="male",
        age_group="adult",
